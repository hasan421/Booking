...
public class Ilan_Guncelle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ilanguncelle);
        baslik = findViewById(R.id.g_baslik);
        il = findViewById(R.id.g_il);
        ilce = findViewById(R.id.g_ilce);
        tip = findViewById(R.id.g_mülktipi);
        oda = findViewById(R.id.g_odasayisi);
        isitma = findViewById(R.id.g_isitma);
        kat = findViewById(R.id.g_kat);
        kira = findViewById(R.id.g_kira);
        adres = findViewById(R.id.g_adres);
        imageView = findViewById(R.id.resim);
        guncelle=findViewById(R.id.g_guncelle);
    ...
    protected void onResume() {
        guncelle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //veri gönderir.
                veri_ui.Update(ilanlar,bytes);
                Intent intent = new Intent(Ilan_Guncelle.this, Listeleme.class);
                startActivity(intent);
                Toast.makeText(Ilan_Guncelle.this,"Bu Method Çalıştı.",Toast.LENGTH_SHORT).show();
                finish();
            }
        });
        super.onResume();
    ...
    public void valuesOfSpinner() {
        ...
        tipListe.add("oda");
        tipListe.add("ev");
        ArrayAdapter arrayAdapter = new ArrayAdapter(Ilan_Guncelle.this, android.R.layout.simple_spinner_item, tipListe);
        ...
        odaListe.add("3+1");
        odaListe.add("4+1");
        ArrayAdapter arrayAdapter1 = new ArrayAdapter(Ilan_Guncelle.this, android.R.layout.simple_spinner_item, odaListe);
        oda.setAdapter(arrayAdapter1);

        ArrayList<String> isitmaListe = new ArrayList<>();
        isitmaListe.add("Kombi");
        isitmaListe.add("Merkezi");
        ArrayAdapter arrayAdapter2 = new ArrayAdapter(Ilan_Guncelle.this, android.R.layout.simple_spinner_item, isitmaListe);
        isitma.setAdapter(arrayAdapter2);
        ArrayList<String> tipIl = new ArrayList<>();
        tipIl.add("Konya");
        tipIl.add("Ankara");
        tipIl.add("Bursa");
        ArrayAdapter arrayAdapter3 = new ArrayAdapter(Ilan_Guncelle.this, android.R.layout.simple_spinner_item, tipIl);
        ...
        tipKat.add("9.");
        tipKat.add("10.");
        ArrayAdapter arrayAdapter4 = new ArrayAdapter(Ilan_Guncelle.this, android.R.layout.simple_spinner_item, tipKat);
